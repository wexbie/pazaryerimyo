...
const formSchema = z
  .object({
    ...
    phoneNumber: z.string().min(1, { message: 'Telefon Numarası gereklidir.' }),
    email: z
      .string()
      .min(1, { message: 'Email gereklidir.' })
      .email({ message: 'Email geçersiz.' }),
    password: z.string().transform((pwd) => pwd.trim()),
    role: z.string().min(1, { message: 'Rol gereklidir.' }),
    ...
    >
      <DialogContent className='sm:max-w-lg'>
        <DialogHeader className='text-left'>
          ...
          <DialogDescription>
            {isEdit ? 'Kullanıcıyı buradan güncelleyin. ' : 'Yeni kullanıcıyı buradan oluşturun. '}
