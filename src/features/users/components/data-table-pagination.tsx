  ...
  return (
    ...
    >
      <div className='hidden flex-1 text-sm text-muted-foreground sm:block'>
        {table.getFilteredRowModel().rows.length} satırın {table.getFilteredSelectedRowModel().rows.length} tanesi seçildi.
      </div>
      <div className='flex items-center sm:space-x-6 lg:space-x-8'>
        <div className='flex items-center space-x-2'>
          <p className='hidden text-sm font-medium sm:block'>Satır başına sayfa</p>
          <Select
